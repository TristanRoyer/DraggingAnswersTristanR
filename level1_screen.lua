...
local function DisplayQuestion()
    ...
    randomNumber2 = math.random(2, 18)
...
local function DetermineAlternateAnswers()    
    ...
    alternateAnswerBox2.text = alternateAnswer2
     ...
     -- generate incorrect answer and set it in the textbox
    alternateAnswer3 = correctAnswer - math.random(4, 8)
...
local function TouchListenerAnswerBox1(touch)
    ...
    if (answerboxAlreadyTouched == false) and 
        (alternateAnswerBox2AlreadyTouched == false) and (alternateAnswerBox3AlreadyTouched == false) then
...
local function TouchListenerAnswerBox2(touch)
    --only work if none of the other boxes have been touched
    if (answerboxAlreadyTouched == false) and 
        (alternateAnswerBox1AlreadyTouched == false) and (alternateAnswerBox3AlreadyTouched == false) then
...
local function TouchListenerAnswerBox3(touch)
    --only work if none of the other boxes have been touched
    if (answerboxAlreadyTouched == false) and 
        (alternateAnswerBox1AlreadyTouched == false) and (alternateAnswerBox2AlreadyTouched == false)  then
        ...
        elseif (touch.phase == "ended") then
            ...
            --else make box go back to where it was
                ...
                alternateAnswerBox3.x = alternateAnswerBox2PreviousX
                alternateAnswerBox3.y = alternateAnswerBox2PreviousY
            end
        end
    end
end  
